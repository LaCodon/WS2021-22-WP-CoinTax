...
{
    public static function render(string $label, string $name, string $type = 'text', bool $required = true, string $placeholder = ''): string
    {
        ...
        return <<<EOF
            <div class="form-elem">
                ...
                <input class="$errorClass" id="input-$name" value="$oldValue" type="$type" name="$name" placeholder="$placeholder" $requiredAttr>
                $errorSpan
            </div>
            EOF;
    }
